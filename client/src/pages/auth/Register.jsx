        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6">
            ...
            >
              ...
              <p className="text-gray-600">Join our wedding hall booking community</p>
            </motion.div>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              >
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all"
                >
